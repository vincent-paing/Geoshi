...
internal class MultiLineStringJsonAdapter constructor(
    ...
    override fun fromJson(reader: JsonReader): MultiLineString? {
                ...
                0 -> {
                    try {
                        ...
                        throw JsonDataException(
                            ("'type' is not of MultiLineString at ${reader.path}"),
                            exception
                        )
                    }
                }
        ...
        val multiline = MultiLineString(lineStringPositionList)

        return when (val validation = multiline.validate()) {
            is Validation.Valid -> multiline
