...
class MultiPolygonJsonAdapterTest {
    ...
    @Test(expected = JsonDataException::class)
    fun testInvalidMultiValidationWithLineRing() {

        //Given
        val given =
            "{\"type\":\"MultiPolygon\",\"coordinates\":[[[[102.0,2.0],[103.0,2.0],[103.0,3.0],[102.0,3.0],[102.0,1.0]]],[[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]],[[100.2,0.2],[100.2,0.8],[100.8,0.8],[100.8,0.2],[100.2,0.2]]]]}"


        //When
        val actual = moshi.adapter(MultiPolygon::class.java).fromJson(given)
    }

    @Test(expected = JsonDataException::class)
    fun testInvalidMultiValidationWithCoordinates() {

        //Given
        val given =
            "{\"type\":\"MultiPolygon\",\"coordinates\":[[[[192.0,90.0],[103.0,2.0],[103.0,3.0],[192.0,90.0],[102.0,1.0]]],[[[100.0,0.0],[101.0,0.0],[101.0,1.0],[100.0,1.0],[100.0,0.0]],[[100.2,0.2],[100.2,0.8],[100.8,0.8],[100.8,0.2],[100.2,0.2]]]]}"
